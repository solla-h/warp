...
///
/// Unlike [`is_transient_http_error`], errors without a typed HTTP transport
/// cause are treated as permanent. This is intended for operations where
/// user-facing errors are converted into plain `anyhow` errors at the
