use object_models::CloudFolderModel;
...
impl CloudModel {
    ...
    pub fn object_types(&self) -> impl Iterator<Item = &Box<dyn CloudObject>> {
        self.objects_by_id.values()
    }

    pub fn object_types_mut(&mut self) -> impl Iterator<Item = &mut Box<dyn CloudObject>> {
        ...
        match index_variant {
            ...
            DriveIndexVariant::Trash => {
                if let CloudObjectLocation::Space(space) = location {
                    self.directly_trashed_object_types_in_space(space, app)
                        .for_each(|object| {
                            let folder: Option<&CloudFolder> = object.into();
                            if let Some(folder) = folder {
                                self.collapse_all_in_location_helper(
                    ...
                    self.indirectly_trashed_object_types_in_location_without_descendents(
                        location, app,
                    )
                    .for_each(|object| {
                        let folder: Option<&CloudFolder> = object.into();
    ...
    pub fn active_workflows_in_space<'a>(
        ...
        self.active_object_types_in_space(space, app)
            .filter_map(|object| object.into())
    }
    ...
    pub fn active_non_welcome_workflows_in_space<'a>(
        ...
        self.active_non_welcome_object_types_in_space(space, app)
            .filter_map(|object| object.into())
    }
    ...
    #[cfg(test)]
    pub fn as_object_types(&self) -> impl Iterator<Item = &'_ Box<dyn CloudObject>> {
        self.objects_by_id.values()
    }
    ...
    pub fn active_object_types_in_location_without_descendents<'a>(
        &'a self,
        location: CloudObjectLocation,
        app: &'a AppContext,
    ...
    /// that live directly in this location (its children). I.e. this function does NOT look into nested folders in order
    /// to return those children.
    pub fn trashed_object_types_in_location_without_descendents<'a>(
        &'a self,
        location: CloudObjectLocation,
        app: &'a AppContext,
    ) -> impl Iterator<Item = &'a dyn CloudObject> + 'a {
    ...
    /// Helper function for trashed_object_types_in_location_with_descendants.
    ...
    fn trashed_cloud_object_types_in_location_with_descendants_helper(
        ...
        self.trashed_object_types_in_location_without_descendents(location, app)
            .for_each(|object| {
    ...
    pub fn indirectly_trashed_object_types_in_location_without_descendents<'a>(
        &'a self,
        location: CloudObjectLocation,
        app: &'a AppContext,
    ...
    pub fn active_object_types_in_space<'a>(
        &'a self,
        space: Space,
        app: &'a AppContext,
    ) -> impl Iterator<Item = &'a dyn CloudObject> + 'a {
    ...
    /// Returns all active (not trashed) cloud objects in the space.
    pub fn active_non_welcome_object_types_in_space<'a>(
        &'a self,
        space: Space,
        app: &'a AppContext,
    ) -> impl Iterator<Item = &'a dyn CloudObject> + 'a {
    ...
    pub fn all_object_types_in_space<'a>(
        &'a self,
        space: Space,
        app: &'a AppContext,
    ) -> impl Iterator<Item = &'a dyn CloudObject> + 'a {
    ...
    pub fn trashed_object_types_in_space<'a>(
        &'a self,
        space: Space,
        app: &'a AppContext,
    ) -> impl Iterator<Item = &'a dyn CloudObject> + 'a {
    ...
    pub fn directly_trashed_object_types_in_space<'a>(
        &'a self,
        space: Space,
        app: &'a AppContext,
    ) -> impl Iterator<Item = &'a dyn CloudObject> {
    ...
    pub fn num_active_object_types_per_space<'a, I>(
        &self,
        spaces: I,
        app: &AppContext,
    ) -> HashMap<Space, usize>
        ...
        I: Iterator<Item = &'a Space>,
    {
        spaces
            .map(|space| {
                (
                    *space,
                    self.active_object_types_in_space(*space, app).count(),
                )
            })
            .collect::<HashMap<_, _>>()
    }
    ...
    pub fn num_trashed_object_types_per_space<'a, I>(
        &self,
        spaces: I,
        app: &AppContext,
    ) -> HashMap<Space, usize>
        ...
        I: Iterator<Item = &'a Space>,
    {
        spaces
            .map(|space| {
                (
                    *space,
                    self.trashed_object_types_in_space(*space, app).count(),
                )
            })
            .collect::<HashMap<_, _>>()
    }
    ...
    pub fn update_objects_from_initial_load<K, M>(
        &mut self,
        object_types: Vec<GenericServerObject<K, M>>,
        force_refresh: bool,
        emit_events: bool,
        ctx: &mut ModelContext<Self>,
    ...
    where
        ...
        M: CloudModelType<IdType = K, CloudObjectType = GenericCloudObject<K, M>> + 'static,
    {
        let updated_objects = object_types
            .into_iter()
            .filter_map(|object| {
    ...
    pub fn object_types_force_refresh_pending(&self) -> bool {
    ...
    pub fn mark_object_types_refresh_as_completed(&mut self) -> DateTime<Utc> {
