...
use object_types::cloud_object::UpdatedObjectInput;
...
pub use object_types::cloud_object::*;
...
impl UpdateManager {
    ...
    pub fn update_ai_execution_profile(&mut self, _data: object_models::ai_execution_profile::AIExecutionProfile, _id: SyncId, _rev: Option<Revision>, _ctx: &mut warpui::ModelContext<Self>) {}
