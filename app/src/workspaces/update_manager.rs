...
impl TeamUpdateManager {
    pub fn new<A: 'static, B: 'static, C: 'static>(_a: A, _b: B, _c: C, _ctx: &mut ModelContext<Self>) -> Self { Self }
    ...
    pub fn leave_team<A: 'static, B: 'static, C: 'static>(&mut self, _a: A, _b: B, _c: C, _ctx: &mut ModelContext<Self>) {}
    pub fn create_team<A: 'static, B: 'static, C: 'static, D: 'static>(&mut self, _a: A, _b: B, _c: C, _d: D, _ctx: &mut ModelContext<Self>) {}
